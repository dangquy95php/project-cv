...
<main class="p-tayorou-tool_guide_detail u-detail">
    <section class="c-breadcrumb2">
        <div class="l-container2">
            <ul class="c-breadcrumb2__inner">
                ...
                <li class="c-breadcrumb2__item"><a href="/tool_guide/">ツールガイド</a></li>
                ...
                <div class="l-layout1__right">
                    <div class="c-side01">
                        <div class="c-side01__inner2">
                            ...
                            <?php echo do_shortcode('[new_acticle tax="tool_guide"]'); ?>
                            <!-- ========================================= -->
                        </div>
    ...
    <?php $featured_posts = get_field('single_postList_tool_guide');
    if( $featured_posts ): ?>
