...
<main class="p-tayorou-hr_news_detail u-detail">
    ...
    <section class="p-tayorou-hr_news_detail1">
        <div class="l-container2">
            <div class="l-layout1">
                <div class="l-layout1__left">
                    <!-- ========================================= -->
                    <div class="c-box27 green">
                    ...
                    <?php endif; ?>
                    <!-- ========================================= -->
                    <?php $obs_id = get_field('writer_list');
                    if($obs_id): ?>
                    <div class="c-box30">
                        <div class="c-box30__head">
                            <?php $image = get_field('writer_image', $obs_id);
                            if($image): ?>
                            <img class="c-box30__img" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo get_the_title($obs_id); ?>" />
                            <?php endif; ?>
                            <div class="c-box30__tit">
                                <p class="c-box30__tit1"><?php echo get_the_title($obs_id); ?></p>
                                <?php if(get_field('writer_job', $obs_id)): ?>
                                <p class="c-box30__tit2"><?php echo get_field('writer_job', $obs_id); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="c-box30__txt"><?php echo get_field('writer_text', $obs_id); ?></div>
                    </div>
                    <?php endif; ?>
                    <!-- ========================================= -->
                    <div class="c-box28">
                ...
                <div class="l-layout1__right">
                    <div class="c-side01">
                        <div class="c-side01__inner2">
                            ...
                            <!-- ========================================= -->
                            <h3 class="c-title25">
                                <span class="c-title25__jp">HR News新着記事</span>
                                <span class="c-title25__en c-title25__en--color2">NEW ARTICLES</span>
                            </h3>
                            <?php echo do_shortcode('[new_acticle tax="hr_news"]'); ?>
                        </div>
    ...
    <?php
    $featured_posts = get_field('single_postList_hr_news');
    if( $featured_posts ): ?>
