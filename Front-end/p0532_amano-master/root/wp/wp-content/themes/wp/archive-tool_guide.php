...
<main class="p-tayorou-tool_guide">
    <section class="c-breadcrumb2">
        <div class="l-container2">
            <ul class="c-breadcrumb2__inner">
                <li class="c-breadcrumb2__item"><a href="/">ホーム</a></li>
                <li class="c-breadcrumb2__item"><span>ツールガイド</span></li>
            </ul>
        </div>
    </section>
    <section class="p-tayorou-tool_guide1">
        <div class="l-container2">
            <div class="l-layout1">
                    ...
                    <div class="c-title23">
                        <div class="c-title23__inner">
                            ...
                            <div class="c-title23__tit">
                                ...
                                <h2 class="c-title23__tit__txt">ツール<br class="sp-only">ガイド</h2>
                            </div>
                        </div>
