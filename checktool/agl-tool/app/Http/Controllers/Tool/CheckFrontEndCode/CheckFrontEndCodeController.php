            ...
            foreach ($infoSourcecode_de as $key => $value) {
                if($value->url == $url){
                    if(isset($request->design_info)){
                        ...
                        $m_path = str_replace(".html","__m.html",$path);
                        $m_path = str_replace(".php","__m.php",$m_path);
                        $content = File::get($path);
                           ...
                           function screenshot(){
                              html2canvas(document.body,{ 
	    							...
	    							taintTest: false
	                               	...
	                               	//loading html
	                               	var thtml = '<div style=\"line-height: 100vh; text-align:center;\"><img style=\"vertical-align: middle;\" src=\"https://cdn.dribbble.com/users/3337757/screenshots/6825268/076_-loading_animated_dribbble_copy.gif\" width=\"50%\" height=\"auto\"></div>';
	                               	$('body').html(thtml);
                            ...
                            window.onload = function() {
                            	$('html, body').animate({scrollTop:$(document).height()}, 2000, function(){
                            		...
                            		window.scrollTo(0, 0);
						        	setTimeout(function(){ screenshot(); }, ".$delay_time.");
						      	});
                            };
                        ...
                        $value->url = str_replace(".html","__m.html",addslashes($value->url));
                        $value->url = str_replace(".php","__m.php",$value->url);
                        return '
                        <!DOCTYPE html>
                        <html>
                        <head>
