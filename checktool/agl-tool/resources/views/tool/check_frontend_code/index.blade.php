          ...
          <div class="col-md-12">
              <div class="card">
                  <div class="card-header" style="text-align: center;">
                      ...
                      <button id="btnUploadSource" type="button" class="btn btn-primary float-right">UPLOAD SOURCE ( ZIP, RAR, 7ZIP )</button>
                                      ...
                                      @endif                                          
                                            <div class="row text-center">
                                              <div id="form-compare-result" class="col-sm text-left" style="width: 210px;">
                                                <h4><a href="{{ $result_key }}" target="_blank">{{  $result['name']  }}</a></h4>
                                                <br>
                                                <div style="display: inline-block;">                                                 
                                                  @if($info[$result_key]['perfectpixel'] == true)                                                    
                                                    <label for="perfectpixel">Perfect pixel : </label> 
                                                    <a id="perfectpixel" target="_blank" class="btn btn-sm btn-primary" href="{{ $result['result']->result }}">{{ round($result['result']->rate,2) }}%</a>
                                                  @endif
                                                </div>
                                                <form method="post" action="{{route('checkfrontendcode_choose_design')}}">
                                                  <div class="form-group">
                                                    ...
                                                    <p>Delay time : <input type="number" name="delay_time" min="0" max="99" step="0.1" value="0" style="text-align:right;"> ( second )</p>
                                                    </div>
                                                </form>                                             
                                            </div>                                          
                                            <div class="row text-center">                                              
          ...
          <div class="col-md-12">
              <div class="card">
                  <div class="card-header" >
                    <a style="font-size: 1.2rem;">MANAGER DESIGN</a>
                    <button id="btnUploadDesign" type="button" class="btn btn-success float-right">UPLOAD DESIGN<br> ( PSD, PNG, JPG )</button>                 
                          ...
                          <tbody>
                            @foreach($file_array as $file)
                              <tr>
                                ...
                                <td style="width: 200px;"><div style="background: url('{{$file[1]}}');background-size: cover; width: 100%; height: 150px;"></div></td>
