        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="text-align: center;">
                    ...
                    <a style="font-size: 1.2rem;">CHATWORK LIST GROUP ( {{ $user_config->account_name }} )</a>
                    <a class="btn btn-primary float-right" href="{{route('chatwork_translate_v3_logout')}}" target="" >&nbsp;Log out</a>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    ...
    function updateRoom(){
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: "{{ route('chatwork_translate_v3_updateRoom') }}",
            data: {
                "_token": "{{ csrf_token() }}",
    ...
    function initPage(){
        var text = "{{ $user_config->room_id_array }}";
        if(text != ""){
            text = text.replace(/&quot;/g,'"');
