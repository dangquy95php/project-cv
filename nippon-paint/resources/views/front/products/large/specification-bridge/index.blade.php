<x-header>
    <x-slot name="title">絞り込み検索結果｜橋梁・コンクリート｜仕様を探す｜日本ペイント株式会社</x-slot>
    <x-slot name="description">日本ペイント株式会社の「重防食用塗料／橋梁・コンクリート」の製品仕様の絞り込み検索結果です。条件に合わせて仕様を絞り込むことができます。</x-slot>
...
<main class="p-bridge">
    ...
    <section class="p-bridge1">
        <div class="l-cont">
            <h2 class="c-title2 c-title2__style2">条件検索結果<span>／ 橋梁・コンクリート ／ 仕様を探す</span></h2>
            <p class="p-bridge1__txt">“{{ $bridge_search->getConditionsStr() }}”の検索結果です。</p>
            <div class="c-block2">
