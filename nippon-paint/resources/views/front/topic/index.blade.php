<x-header>
    ...
    <x-slot name="description">日本ペイント株式会社の{{ $title }}に関するお知らせ一覧です。</x-slot>
    ...
    <x-slot name="url">https://www.nipponpaint.co.jp/news/{{ $title }}/</x-slot>
</x-header>
        ...
        <div class="c-blocklist">
            <div class="l-cont">
                ...
                <div class="c-blocklist__wrapper">
                    @if (isset($topics))
                        <div id="app">
                            <topics-list-component api="/news"
