...
@section('auth_body')
    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            {{ Form::select('role_type', \App\Models\AdminUser::ADMIN_USER_ROLES, old('role_type'), ['class' => 'form-control']) }}
        ...
        {{-- Name field --}}
        <div class="input-group mb-3">
            <input type="text" name="username" class="form-control {{ $errors->has('username') ? 'has-error' : '' }}"
