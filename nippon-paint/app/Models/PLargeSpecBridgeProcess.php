...
class PLargeSpecBridgeProcess extends PLargeSpecProcess
{
    protected $touches = ['p_large_spec_bridge'];

    /**
     * 仕様｜橋梁・コンクリートリレーション
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function p_large_spec_bridge()
    {
        return $this->belongsTo(PLargeSpecBridge::class);
    }
    ...
    {
        if($standard = $this->p_large_spec_bridge->p_large_standard){
